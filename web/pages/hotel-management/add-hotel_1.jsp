                            ...
                            <div class="col-lg-9">
                                <form action="${pageContext.request.contextPath}/add-hotel" method="POST" enctype="multipart/form-data" id="addHotelForm">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="hotelDescription" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="mb-3">
                                                            <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                                <input class="form-check-input ms-0 mt-0" type="checkbox" id="service-${service.serviceId}" name="serviceIds" value="${service.serviceId}">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <button type="button" class="btn btn-light me-2" onclick="document.getElementById('addHotelForm').reset(); $('#galleryPreview').empty();">Reset</button>
