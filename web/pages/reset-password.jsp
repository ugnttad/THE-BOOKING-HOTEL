    ...
    <body class="bg-light-200">
                    ...
                    <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-11 mx-auto">
                            ...
                            <div class="card authentication-card">
                                ...
                                <div class="card-body">
                                    <form id="rp-form" action="${pageContext.request.contextPath}/reset-password">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input name="newPassword" type="password" class="form-control form-control-lg pass-input" placeholder="Enter Password">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                let form = document.getElementById("rp-form");
