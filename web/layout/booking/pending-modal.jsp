                ...
                <div class="upcoming-content">
                    <div class="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="me-2">
                                <img src="${pageContext.request.contextPath}/assets/img/hotels/hotel-13.jpg" alt="image" class="avatar avartar-md avatar-rounded">
                            </div>
                            <div>
                    ...
                    <div class="upcoming-details">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <p class="text-gray-6 fs-16 "><a href="https://dreamstour.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c8aba0baaea7fafbfdfe88adb0a9a5b8a4ade6aba7a5">[email&#160;protected]</a></p>
                            </div>
                            <div class="col-lg-3">
